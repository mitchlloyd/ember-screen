...
This file was copied from https://github.com/ericf/css-mediaquery/blob/master/index.js
so that is could be easily used with Ember CLI.
*/
...
// Library End
    ...
    return { matchQuery: matchQuery, parseQuery: parseQuery };
  }

  define('css-mediaquery', [], vendorModule);
})();
